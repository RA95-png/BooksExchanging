...
--------------
INSERT INTO `exchanging_books`.`quality` (`donation`, `exchange`, `sale`, `name_book_exchange`, `price`, `nagotiable`) VALUES ('1', '0', '0', '0', '0', '0');
...
INSERT INTO `exchanging_books`.`books` (`NameBook`, `NameAuthor`, `version_date`, `id_univer`, `id_college`, `id_department`, `id_quality`, `img`, `id_user`) VALUES ('calculus 1', 'ahmad', '3/20', '1', '8', '49', '1', 'w', '1');
